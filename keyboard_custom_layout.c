...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_PLOVER] = {
    ...
    {KC_LSFT, KC_0,        KC_PGUP, KC_PGDN, KC_0, KC_0, KC_0,  KC_0, KC_VOLD, KC_VOLU, KC_0,    KC_RSFT},
    {KC_BSPC, MO(_CUSTOM), KC_LGUI, KC_C,    KC_V, KC_N, KC_N,  KC_M, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
  },
  [_QWERTY] = {
  ...
  [_CUSTOM] = {
    ...
    {DF(_PLOVER), DF(_QWERTY), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN2},
