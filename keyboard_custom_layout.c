...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_PLOVER] = {
    {KC_Q,    KC_W,        KC_E,    KC_R, KC_H, KC_BSPC, KC_H,  KC_U, KC_I,    KC_O,    KC_P,    KC_LBRC},
    {KC_A,    KC_S,        KC_D,    KC_F, KC_H, KC_PGUP, KC_H,  KC_J, KC_K,    KC_L,    KC_SCLN, KC_QUOT},
    {KC_LSFT, KC_RSFT,     KC_0,    KC_0, KC_0, KC_PGDN, KC_0,  KC_0, KC_0,    KC_0,    KC_0,    KC_ENT},
