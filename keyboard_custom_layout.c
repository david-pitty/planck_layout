...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_PLOVER] = {
    {KC_Q,    KC_W, KC_E,    KC_R,    KC_H, KC_0, KC_H,  KC_U,        KC_I,    KC_O,    KC_P,    KC_LBRC},
    {KC_A,    KC_S, KC_D,    KC_F,    KC_H, KC_0, KC_H,  KC_J,        KC_K,    KC_L,    KC_SCLN, KC_QUOT},
    {KC_LSFT, KC_0, KC_PGUP, KC_PGDN, KC_0, KC_0, KC_0,  DF(_QWERTY), KC_VOLD, KC_VOLU, KC_0,    KC_RSFT},
    {KC_BSPC, KC_4, KC_LGUI, KC_C,    KC_V, KC_N, KC_N,  KC_M,        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
  },
  [_QWERTY] = {
